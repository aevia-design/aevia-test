...
| 41 | Build Scribble template engine — Plans 06-01/02/03 complete. Remaining: 07-01/02/03, 08-01/02, 09-01. See `whats-next.md`. | High | In progress | `pages/template-engine.html` + `assets/Template_Scribble/template-data.js`. Template renamed Scribble (was Toddler/Sprout). FP1 heart clip working. Captions, drag-drop, print export not yet started. |
