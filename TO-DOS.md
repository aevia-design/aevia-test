...
| 60 | Clean up QA test orders | Low | AEV-023 (corrupted customer-side) + any orders the chain script creates are real Firestore test orders. Delete once QA automation is stable. |
