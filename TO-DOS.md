...
| 41 | Build Scribble template engine — Plans 06–08 complete. Remaining: 09-01 (print/export), 10-01 (bloom.html). See `whats-next.md`. | High | In progress | `pages/template-engine.html` + `assets/Template_Scribble/template-data.js`. Drag-drop, captions, AI captions, FP text panels, special photo uploads all done. |
