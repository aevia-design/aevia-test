...
| 90 | Stranded orders have no resume path | AEV-067/073/074/079, AEV-096. Reproducible in 30s now. Open design question: can a customer resume at all? **Worth more since #112 (S173): a failed upload now leaves nearly every photo already in GCS (105 of 106, not ~28), so the expensive half of a resume is already done — but resubmitting mints a NEW order number and re-uploads everything, orphaning those bytes.** → [notes](docs/todo-notes.md#90) |
