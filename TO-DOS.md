...
| 41 | ~~Build Toddler template engine~~ Plans 06-01 + 06-02 complete. Remaining: 06-03, 07-01/02/03, 08-01/02, 09-01. See `whats-next.md`. | High | In progress | `pages/template-engine.html` + `assets/Template_Toddler/template-data.js`. FP1 blocked: Kseniia must remove Background_Color rect from birthday SVGs. |
