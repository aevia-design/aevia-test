...
window.HEIRLOOM_BLUE_DATA = {
  ...
  monograms: {
    roots: {
      ...
      backLetters: [
        { key: 'letter1', xMm: 113, yMm: 107, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 22, color: '#3d3d4f' },
        { key: 'letter2', xMm: 113, yMm: 130, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 22, color: '#3d3d4f' },
      ],
    },
    birds: {
      label: 'Birds',
      ...
      backLetters: [
        { key: 'letter1', xMm: 111, yMm: 108, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 22, color: '#3d3d4f' },
        { key: 'letter2', xMm: 116, yMm: 124.5, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 22, color: '#3d3d4f' },
      ],
    },
    roses: {
      label: 'Roses',
      ...
      backLetters: [
        { key: 'letter1', xMm: 98.2, yMm: 123, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 22, color: '#3d3d4f' },
        { key: 'letter2', xMm: 128.2, yMm: 123, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 22, color: '#3d3d4f' },
      ],
    },
  },
  ...
  cover: {
    ...
    captions: [
      { key: 'name',  xMm: 333, yMm: 183, wMm: 100, hMm: 30, font: 'IM FELL English', sizePt: 50, align: 'center', color: '#3d3d4f', letterSpacing: 0.01, label: 'Front — names', labelDe: 'Vorderseite — Namen', placeholder: 'ANNA & MICHAEL', placeholderDe: 'ANNA & MICHAEL', maxLength: 100 },
