...
window.HEIRLOOM_GREEN_DATA = {
  ...
  cover: {
    ...
    captions: [
      { key: 'name',  xMm: 327, yMm: 183, wMm: 100, hMm: 30, font: 'IM FELL English', sizePt: 50, align: 'center', color: '#dad0c5', letterSpacing: 0.01, label: 'Front — names', placeholder: 'ANNA & MICHAEL', maxLength: 100 },
      { key: 'spine', xMm: 223, yMm: 118, wMm: 70,  hMm: 6,  font: 'IM FELL English', sizePt: 16, align: 'center', color: '#dad0c5', letterSpacing: 0.01, rotate: 270, label: 'Spine — label', placeholder: 'Anna & Michael', maxLength: 100 },
    ]
  },
