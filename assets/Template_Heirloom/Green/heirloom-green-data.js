...
window.HEIRLOOM_GREEN_DATA = {
  ...
  spreads: {
    ...
    FPhim: {
      ...
      pages: {
        left: {
          default: { bgColor: '#dad0c5', svg: 'FP Spread 2 Why I love/FP 03 Why Him Left.svg', slots: [],
    ...
    FPher: {
      ...
      pages: {
        left: {
          default: { bgColor: '#dad0c5', svg: 'FP Spread 2 Why I love/FP 03 Why Her Left.svg', slots: [],
            textPanel: { introFields: true, caption: { allowed: true, xMm: 98, yMm: 98, wMm: 110, hMm: 110, halign: 'center', valign: 'center', font: 'IM FELL English', sizePt: 16, style: 'regular', letterSpacing: 0.01, lineSpacing: 1.28, color: '#404737' } } },
        },
        right: {
