/* Heirloom (Green) — archival wedding photobook template (Aevia "Love" collection).
 ...
 * render time. SVG paths are relative to assets/Template_Heirloom/Green/SVG/.
 *
 * Built from Heirloom_sizing_full_Green.csv + Heirloom_Template_Sizing_Cover_40_Green.csv
 ...
 */
window.HEIRLOOM_GREEN_DATA = {
  template: 'heirloom-green',
  pageSize: 200,
  bleed: 3,
  canvasPx: 600,
  ...
  monograms: {
    roots: {
      ...
      introLetters: [
        { key: 'letter1', xMm: 107.2, yMm: 152, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 23, color: '#404737' },
        { key: 'letter2', xMm: 107.2, yMm: 174, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 23, color: '#404737' },
      ],
      backLetters: [
        { key: 'letter1', xMm: 113, yMm: 107, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 22, color: '#dad0c5' },
        { key: 'letter2', xMm: 113, yMm: 130, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 22, color: '#dad0c5' },
      ],
    },
    birds: {
      label: 'Birds',
      ...
      coverClipShape: 'coverFrameShifted',
      introLetters: [
        { key: 'letter1', xMm: 106, yMm: 153, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 23, color: '#404737' },
        { key: 'letter2', xMm: 111, yMm: 169.5, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 23, color: '#404737' },
      ],
      backLetters: [
        { key: 'letter1', xMm: 111, yMm: 108, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 22, color: '#dad0c5' },
        { key: 'letter2', xMm: 116, yMm: 124.5, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 22, color: '#dad0c5' },
      ],
    },
    roses: {
      label: 'Roses',
      ...
      introLetters: [
        { key: 'letter1', xMm: 93.7,  yMm: 167, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 23, color: '#404737' },
        { key: 'letter2', xMm: 120.7, yMm: 167, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 23, color: '#404737' },
      ],
      backLetters: [
        { key: 'letter1', xMm: 98.2, yMm: 123, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 22, color: '#dad0c5' },
        { key: 'letter2', xMm: 128.2, yMm: 123, wMm: 8, hMm: 9, font: 'IM FELL English', sizePt: 22, color: '#dad0c5' },
      ],
    },
  },
  ...
  cover: {
    ...
    sections: {
      back:  { xMm: 0,   wMm: 200, bgColor: '#969e8a' },
      // Spine band is the same beige as the panels (cover SVG rect at x 566.929, 10mm wide).
      spine: { xMm: 200, wMm: 10,  bgColor: '#969e8a' },
      front: { xMm: 210, wMm: 200, bgColor: '#969e8a' },
    },
    // Cover artwork + coordinates authored against the 40pp 10mm spine (410mm trim).
    referenceSpineMm: 10,
    mockupEdges: { front: '#969e8a', spine: '#969e8a', back: '#969e8a' },
    ...
    slots: [
      // xMm tracks the opening centre (315.00 trim + 18 bleed), same as Beige (S195). The second cover
      ...
      { key: 'cover', xMm: 333, yMm: 98, wMm: 80, hMm: 80, pool: 'cover', orientation: 'square', clipShape: 'coverFrameShifted' }
    ],
    ...
    captions: [
      { key: 'name',  xMm: 333, yMm: 183, wMm: 100, hMm: 30, font: 'IM FELL English', sizePt: 50, align: 'center', color: '#dad0c5', letterSpacing: 0.01, label: 'Front — names', labelDe: 'Vorderseite — Namen', placeholder: 'ANNA & MICHAEL', placeholderDe: 'ANNA & MICHAEL', maxLength: 100 },
      { key: 'spine', xMm: 223, yMm: 118, wMm: 70,  hMm: 6,  font: 'IM FELL English', sizePt: 16, align: 'center', color: '#dad0c5', letterSpacing: 0.01, rotate: 270, label: 'Spine — label', labelDe: 'Buchrücken — Text', placeholder: 'Anna & Michael', placeholderDe: 'Anna & Michael', maxLength: 100 },
    ]
  },
  ...
  spreads: {
      ...
      pages: {
        left: {
          H: { bgColor: '#dad0c5', svg: 'SP Spread 1/SP 01 H Left.svg',
            slots: [ { slot: 1, x: 95, y: 100, xBleed: 98, yBleed: 103, w: 150, h: 100, ratio: '3:2', caption: { allowed: true, xMm: 98, yMm: 169.5, wMm: 100, hMm: 13, halign: 'center', valign: 'top', font: 'IM FELL English', sizePt: 16, style: 'regular', letterSpacing: 0.01, lineSpacing: 1.28, color: '#404737' } } ] },
          V: { bgColor: '#dad0c5', svg: 'SP Spread 1/SP 01 V Left.svg',
            slots: [ { slot: 1, x: 95, y: 90, xBleed: 98, yBleed: 93, w: 120, h: 160, ratio: '3:4', caption: { allowed: true, xMm: 98, yMm: 184.5, wMm: 100, hMm: 13, halign: 'center', valign: 'top', font: 'IM FELL English', sizePt: 16, style: 'regular', letterSpacing: 0.01, lineSpacing: 1.28, color: '#404737' } } ] },
        },
        right: {
      ...
      pages: {
        ...
        right: {
          H: { bgColor: '#dad0c5', svg: 'SP Spread 3/SP 06 H Right.svg',
            slots: [ { slot: 1, x: 105, y: 70, xBleed: 108, yBleed: 73, w: 150, h: 100, ratio: '3:2', caption: { allowed: true, xMm: 108, yMm: 179.5, wMm: 100, hMm: 13, halign: 'center', valign: 'top', font: 'IM FELL English', sizePt: 16, style: 'regular', letterSpacing: 0.01, lineSpacing: 1.28, color: '#404737' } } ] },
          V: { bgColor: '#dad0c5', svg: 'SP Spread 3/SP 06 V Right.svg',
            slots: [ { slot: 1, x: 85, y: 100, xBleed: 88, yBleed: 103, w: 120, h: 160, ratio: '3:4', caption: { allowed: true, xMm: 173, yMm: 43, wMm: 40, hMm: 40, halign: 'left', valign: 'top', font: 'IM FELL English', sizePt: 16, style: 'regular', letterSpacing: 0.01, lineSpacing: 1.28, color: '#404737' } } ] },
        },
      }
    },
      ...
      pages: {
        ...
        right: {
          H: { bgColor: '#dad0c5', svg: 'SP Spread 4/SP 08 H Right.svg',
            slots: [ { slot: 1, x: 105, y: 100, xBleed: 108, yBleed: 103, w: 150, h: 100, ratio: '3:2', caption: { allowed: true, xMm: 108, yMm: 169.5, wMm: 100, hMm: 13, halign: 'center', valign: 'top', font: 'IM FELL English', sizePt: 16, style: 'regular', letterSpacing: 0.01, lineSpacing: 1.28, color: '#404737' } } ] },
          V: { bgColor: '#dad0c5', svg: 'SP Spread 4/SP 08 V Right.svg',
            slots: [ { slot: 1, x: 105, y: 90, xBleed: 108, yBleed: 93, w: 120, h: 160, ratio: '3:4', caption: { allowed: true, xMm: 108, yMm: 184.5, wMm: 100, hMm: 13, halign: 'center', valign: 'top', font: 'IM FELL English', sizePt: 16, style: 'regular', letterSpacing: 0.01, lineSpacing: 1.28, color: '#404737' } } ] },
        },
      }
    },
      ...
      pages: {
        ...
        right: {
          H: { bgColor: '#dad0c5', svg: 'SP Spread 5/SP 10 H Right.svg',
            slots: [ { slot: 1, x: 105, y: 130, xBleed: 108, yBleed: 133, w: 150, h: 100, ratio: '3:2', caption: { allowed: true, xMm: 108, yMm: 66.5, wMm: 100, hMm: 13, halign: 'center', valign: 'top', font: 'IM FELL English', sizePt: 16, style: 'regular', letterSpacing: 0.01, lineSpacing: 1.28, color: '#404737' } } ] },
          V: { bgColor: '#dad0c5', svg: 'SP Spread 5/SP 10 V Right.svg',
            slots: [ { slot: 1, x: 105, y: 110, xBleed: 108, yBleed: 113, w: 120, h: 160, ratio: '3:4', caption: { allowed: true, xMm: 108, yMm: 21.5, wMm: 100, hMm: 13, halign: 'center', valign: 'top', font: 'IM FELL English', sizePt: 16, style: 'regular', letterSpacing: 0.01, lineSpacing: 1.28, color: '#404737' } } ] },
        },
      }
    },
      ...
      pages: {
        right: {
          default: {
            ...
            slots: [],
            textPanel: { introFields: true, caption: { allowed: true, xMm: 108, yMm: 83, wMm: 110, hMm: 100, halign: 'center', valign: 'center', font: 'IM FELL English', sizePt: 16, style: 'regular', letterSpacing: 0.01, lineSpacing: 1.28, color: '#404737' } }
          },
        },
      }
    },
    ...
    FPstory: {
      ...
      pages: {
        ...
        right: {
          default: { bgColor: '#dad0c5', svg: 'FP Spread 1 Our story/FP 02 Our story Right.svg', svgDe: 'FP Spread 1 Our story/Our story Right-DE.svg', slots: [],
    ...
    FPhim: {
      ...
      pages: {
        left: {
          default: { bgColor: '#dad0c5', svg: 'FP Spread 2 Why I love/FP 03 Why Him Left.svg', svgDe: 'FP Spread 2 Why I love/Why Him Left-DE.svg', slots: [],
            textPanel: { introFields: true, caption: { allowed: true, xMm: 98, yMm: 98, wMm: 110, hMm: 110, halign: 'center', valign: 'center', font: 'IM FELL English', sizePt: 16, style: 'regular', letterSpacing: 0.01, lineSpacing: 1.28, color: '#404737' } } },
        },
        right: {
          default: { bgColor: '#dad0c5', svg: 'FP Spread 2 Why I love/FP 03 Why Him Right.svg',
    ...
    FPher: {
      ...
      pages: {
        left: {
          default: { bgColor: '#dad0c5', svg: 'FP Spread 2 Why I love/FP 03 Why Her Left.svg', svgDe: 'FP Spread 2 Why I love/Why Her Left-DE.svg', slots: [],
            textPanel: { introFields: true, caption: { allowed: true, xMm: 98, yMm: 98, wMm: 110, hMm: 110, halign: 'center', valign: 'center', font: 'IM FELL English', sizePt: 16, style: 'regular', letterSpacing: 0.01, lineSpacing: 1.28, color: '#404737' } } },
        },
        right: {
          default: { bgColor: '#dad0c5', svg: 'FP Spread 2 Why I love/FP 03 Why Her Right.svg',
