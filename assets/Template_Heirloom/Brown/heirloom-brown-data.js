/* Heirloom (Brown) — archival wedding photobook template (Aevia "Love" collection).
 ...
 * render time. SVG paths are relative to assets/Template_Heirloom/Brown/SVG/.
 *
 * Built from Heirloom_sizing_full_Brown.csv + Heirloom_Template_Sizing_Cover_40_Brown.csv
 ...
 */
window.HEIRLOOM_BROWN_DATA = {
  template: 'heirloom-brown',
  pageSize: 200,
  bleed: 3,
  canvasPx: 600,
  ...
  cover: {
    ...
    sections: {
      back:  { xMm: 0,   wMm: 200, bgColor: '#312128' },
      // Spine band is the same beige as the panels (cover SVG rect at x 566.929, 10mm wide).
      spine: { xMm: 200, wMm: 10,  bgColor: '#312128' },
      front: { xMm: 210, wMm: 200, bgColor: '#312128' },
    },
    // Cover artwork + coordinates authored against the 40pp 10mm spine (410mm trim).
    referenceSpineMm: 10,
    mockupEdges: { front: '#312128', spine: '#312128', back: '#312128' },
