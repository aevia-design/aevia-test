window.PAPERCUT_DATA = {
  ...
  cover: {
    ...
    captions: [
      ...
      { key: 'spineYear', xMm: 222.5, yMm: 158, wMm: 38,  font: 'Source Sans 3', sizePt: 16, weight: 400, color: '#4a4b40', rotate: 270, label: 'Spine — year', labelDe: 'Buchrücken — Jahr', placeholder: '2026', placeholderDe: '2026', maxLength: 10 },
    ]
  },
