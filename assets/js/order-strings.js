...
window.ORDER_STRINGS = {
  ...
  // S191: messages the form built in JavaScript, which showed English on a German
  // order. Plural pairs end in '1' / 'N'; tn() in order.html picks by count.
  'err.uploadFailed':  { en: 'We could not upload {list}. Press Retry upload or email support@aevia.at and we will finish it for you.',
                         de: 'Wir konnten {list} nicht hochladen. Klicken Sie auf „Upload erneut versuchen“ oder schreiben Sie an support@aevia.at, dann stellen wir die Bestellung für Sie fertig.' },
  'err.uploadStalled': { en: 'Your connection stopped while we were uploading {list}. Check your connection and press Retry upload, or email support@aevia.at and we will finish it for you.',
                         de: 'Ihre Verbindung ist beim Hochladen von {list} abgebrochen. Prüfen Sie Ihre Verbindung und klicken Sie auf „Upload erneut versuchen“, oder schreiben Sie an support@aevia.at, dann stellen wir die Bestellung für Sie fertig.' },
  'list.more':         { en: '{names} and {n} more',       de: '{names} und {n} weitere' },
  'list.photo':        { en: 'photo {n}',                  de: 'Foto {n}' },
  // German conjugates by how many files are named; English does not, so its pair matches.
  'reject.sentence1':  { en: "Couldn't use {list} — {reason}",
                         de: '{list} konnte nicht verwendet werden: {reason}' },
  'reject.sentenceN':  { en: "Couldn't use {list} — {reason}",
                         de: '{list} konnten nicht verwendet werden: {reason}' },
  'reject.raw':        { en: "RAW files can't be printed from directly — please export it as a JPEG first.",
                         de: 'RAW-Dateien lassen sich nicht direkt drucken. Bitte exportieren Sie das Foto zuerst als JPEG.' },
  'reject.format':     { en: 'we can only use {formats} photos.',
                         de: 'wir können nur Fotos im Format {formats} verwenden.' },
  'reject.size':       { en: "it's {mb} MB — please keep photos under {max} MB.",
                         de: 'die Datei hat {mb} MB. Bitte laden Sie nur Fotos unter {max} MB hoch.' },
  'photos.of':         { en: ' of {target}',               de: ' von {target}' },
  'photos.selected1':  { en: '{n} photo selected',         de: '{n} Foto ausgewählt' },
  'photos.selectedN':  { en: '{n} photos selected',        de: '{n} Fotos ausgewählt' },
  'photos.add1':       { en: 'Add {n} more photo',         de: 'Fügen Sie noch {n} Foto hinzu' },
  'photos.addN':       { en: 'Add {n} more photos',        de: 'Fügen Sie noch {n} Fotos hinzu' },
  'photos.remove1':    { en: 'Remove {n} photo',           de: 'Entfernen Sie {n} Foto' },
  'photos.removeN':    { en: 'Remove {n} photos',          de: 'Entfernen Sie {n} Fotos' },
  'photos.lowRes1':    { en: "{n} photo is smaller than we'd like. Messaging apps like WhatsApp shrink photos when they send them, and so do iCloud Shared Albums. Upload the originals from your camera roll and they'll be bigger.",
                         de: '{n} Foto ist kleiner, als wir es uns wünschen. Messenger wie WhatsApp verkleinern Fotos beim Versenden, geteilte iCloud-Alben ebenso. Laden Sie die Originale aus Ihrer Fotomediathek hoch, dann sind sie größer.' },
  'photos.lowResN':    { en: "{n} photos are smaller than we'd like. Messaging apps like WhatsApp shrink photos when they send them, and so do iCloud Shared Albums. Upload the originals from your camera roll and they'll be bigger.",
                         de: '{n} Fotos sind kleiner, als wir es uns wünschen. Messenger wie WhatsApp verkleinern Fotos beim Versenden, geteilte iCloud-Alben ebenso. Laden Sie die Originale aus Ihrer Fotomediathek hoch, dann sind sie größer.' },
  'issue.lowRes1':     { en: "{n} photo is smaller than we'd like. Messaging apps and iCloud Shared Albums shrink photos, so the originals in your camera roll will be bigger.",
                         de: '{n} Foto ist kleiner, als wir es uns wünschen. Messenger und geteilte iCloud-Alben verkleinern Fotos, die Originale in Ihrer Fotomediathek sind größer.' },
  'issue.lowResN':     { en: "{n} photos are smaller than we'd like. Messaging apps and iCloud Shared Albums shrink photos, so the originals in your camera roll will be bigger.",
                         de: '{n} Fotos sind kleiner, als wir es uns wünschen. Messenger und geteilte iCloud-Alben verkleinern Fotos, die Originale in Ihrer Fotomediathek sind größer.' },
  'map.regionMismatch':{ en: '{country} is in {region}, but your trip is in {trip}. One region per map — remove the current countries first to switch regions.',
                         de: '{country} liegt in {region}, Ihre Reise aber in {trip}. Pro Karte ist nur eine Region möglich. Entfernen Sie zuerst die bisherigen Länder, um die Region zu wechseln.' },
  'region.EU':         { en: 'Europe',                     de: 'Europa' },
  'region.Asia':       { en: 'Asia',                       de: 'Asien' },
  'region.Africa':     { en: 'Africa',                     de: 'Afrika' },
  'region.N.America':  { en: 'North America',              de: 'Nordamerika' },
  'region.S.America':  { en: 'South America',              de: 'Südamerika' },
  'region.Oceania':    { en: 'Oceania',                    de: 'Ozeanien' },
  ...
  'auth.cancelled':    { en: 'Sign-in was cancelled.',     de: 'Die Anmeldung wurde abgebrochen.' },
