...
window.TENDER_DATA = {
  ...
  cover: {
    ...
    captions: [
      ...
      { key: 'spine',    xMm: 222.5, yMm: 118, wMm: 45,  hMm: 8,  font: 'Parisienne', sizePt: 18, align: 'center', color: '#fbf8f6', letterSpacing: 0.01, rotate: 270, label: 'Spine — label', placeholder: 'Our wedding', maxLength: 60 },
    ]
  },
