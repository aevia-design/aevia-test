...
- `pages/template-engine.html` — plans through 10-02 complete; cover caption toolbar; spread captions now apply typography from template-data; caption multi-line (Shift+Enter) fixed
- `assets/Template_Scribble/template-data.js` — fully generated by csv-to-template.js; all captions carry font/sizePt/style/letterSpacing/lineSpacing
- `assets/Template_Scribble/Scribble_sizing_full.csv` — caption typography columns added; SP6 left offset corrected to 10mm
- `csv-to-template.js` — reads caption typography columns from both slot and textPanel rows; emits them into template-data.js
- `assets/fonts/EBGaramond-SemiBold.woff2` — added

## Committed and pushed
- All work through this session committed and pushed.
